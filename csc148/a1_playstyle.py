...
class AutomatedPlaystyle(Playstyle):
    """ A class representing an automated playstyle. Inherits from playstyle."""
    ...
    def select_attack(self, parameter: Any = None) -> str:
        """ Return the attack for the next character to perform."""
        return random.choice(self.battle_queue.peek().get_available_actions())
